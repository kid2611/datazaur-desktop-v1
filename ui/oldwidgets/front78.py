...
"selection-background-color: rgb(114, 159, 207);")
    ...
    def add_widgets(self):
        for widget in [MonitorWidget, TradeWidget, AlgorithmWidget, CalendarWidget, ExplorerWidget, NewsWidget, TrendsWidget,
                       PortfolioWidget, WatchlistWidget, EditorWidget]:
