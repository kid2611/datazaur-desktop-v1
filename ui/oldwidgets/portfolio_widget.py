...
class PortfolioWidget(QtWidgets.QWidget):
    ...
    def retranslateUi(self):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("Form", "portfolio 1"))
        self.label.setText(_translate("Form", "portfolios"))
        ...
        self.lineEdit.setPlaceholderText(_translate("Form", "portfolio name"))
